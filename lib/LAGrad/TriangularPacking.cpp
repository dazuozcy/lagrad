...
class ErasePackOp : public OpRewritePattern<lagrad::PackOp> {
public:
  using OpRewritePattern::OpRewritePattern;
  LogicalResult matchAndRewrite(lagrad::PackOp op,
                                PatternRewriter &rewriter) const override {
...
struct PackTriangularPass
  ...
  void runOnOperation() final {
    ...
    erasureTarget.addIllegalDialect<lagrad::LAGradDialect>();
...
std::unique_ptr<Pass> mlir::lagrad::createPackTriangularPass() {
